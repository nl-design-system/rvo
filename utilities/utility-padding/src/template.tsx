...
import LayoutFlow from '../../../components/layout-flow/src/template';
import './index.scss';
...
export const UtilityPadding: React.FC = () => {
  return (
    <LayoutFlow className="rvo-padding--sm">
      <LayoutFlow>
        <p>De volgende utility classes kunnen optioneel worden gebruikt voor paddings aan alle kanten:</p>
        <BorderedBox>
      ...
      <LayoutFlow>
        <p>
          De volgende utility classes kunnen optioneel worden gebruikt voor paddings in sizes 3xs, 2xs, xs, sm, md, lg,
