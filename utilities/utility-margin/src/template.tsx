...
export const UtilityMargin: React.FC = () => {
  return (
    <LayoutFlow className="rvo-margin--sm">
      <LayoutFlow>
        <p>De volgende utility classes kunnen optioneel worden gebruikt voor margins aan alle kanten:</p>
        <BorderedBox>
      ...
      <LayoutFlow>
        <p>
          De volgende utility classes kunnen optioneel worden gebruikt voor margins in sizes 3xs, 2xs, xs, sm, md, lg,
