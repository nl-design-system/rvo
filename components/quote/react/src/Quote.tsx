...
import { isOfType } from '@nl-rvo/component-library-react/src/utils/typeUtils';
import '@nl-rvo/css-quote';
import { IQuoteProps } from './Quote.types';

export const Quote: React.FC<IQuoteProps> = ({ quote, user, ...rootElementProps }) => {
  const renderImage = () => {
    if (!user) return null;
