try{
(()=>{var Xo=Object.defineProperty;var w=(o,e)=>()=>(o&&(e=o(o=0)),e);var Vt=(o,e)=>{for(var t in e)Xo(o,t,{get:e[t],enumerable:!0})};var d=w(()=>{});var g,p=w(()=>{g={NODE_ENV:"production",NODE_PATH:["/home/runner/work/rvo/rvo/node_modules/.pnpm/storybook@7.6.20_encoding@0.1.13/node_modules/storybook/node_modules","/home/runner/work/rvo/rvo/node_modules/.pnpm/storybook@7.6.20_encoding@0.1.13/node_modules","/home/runner/work/rvo/rvo/node_modules/.pnpm/node_modules","/home/runner/setup-pnpm/node_modules/.pnpm/pnpm@10.28.1/node_modules/pnpm/bin/node_modules","/home/runner/setup-pnpm/node_modules/.pnpm/pnpm@10.28.1/node_modules/pnpm/node_modules","/home/runner/setup-pnpm/node_modules/.pnpm/pnpm@10.28.1/node_modules","/home/runner/setup-pnpm/node_modules/.pnpm/node_modules","/home/runner/setup-pnpm/node_modules/.pnpm/pnpm@10.28.1/node_modules/pnpm/bin/node_modules","/home/runner/setup-pnpm/node_modules/.pnpm/pnpm@10.28.1/node_modules/pnpm/node_modules","/home/runner/setup-pnpm/node_modules/.pnpm/pnpm@10.28.1/node_modules","/home/runner/setup-pnpm/node_modules/.pnpm/node_modules"],STORYBOOK:"true",PUBLIC_URL:"."}});var h=w(()=>{});var Xi,qi,Ki,Zt,Ji,Qi,es,ts,rs,os,ns,is,ss,as,Gt,ls,cs,us,ds,ps,hs,fs,ms,Te,gs,ke,vs,ys,re,bs,xs,_s,ws,I,$s,Ss,Es,Xt,As,Ps,Cs,Ms,Ts,ks,Os,Ns,Rs,Bs,js,qt,Ls,Is,Fs,Hs,Us,zs,Ds,Vs,Ys,Ws,Zs,Gs,Xs,qs,Ks,Js,Qs,U=w(()=>{d();p();h();Xi=__STORYBOOK_COMPONENTS__,{A:qi,ActionBar:Ki,AddonPanel:Zt,Badge:Ji,Bar:Qi,Blockquote:es,Button:ts,ClipboardCode:rs,Code:os,DL:ns,Div:is,DocumentWrapper:ss,ErrorFormatter:as,FlexBar:Gt,Form:ls,H1:cs,H2:us,H3:ds,H4:ps,H5:hs,H6:fs,HR:ms,IconButton:Te,IconButtonSkeleton:gs,Icons:ke,Img:vs,LI:ys,Link:re,ListItem:bs,Loader:xs,OL:_s,P:ws,Placeholder:I,Pre:$s,ResetWrapper:Ss,ScrollArea:Es,Separator:Xt,Spaced:As,Span:Ps,StorybookIcon:Cs,StorybookLogo:Ms,Symbols:Ts,SyntaxHighlighter:ks,TT:Os,TabBar:Ns,TabButton:Rs,TabWrapper:Bs,Table:js,Tabs:qt,TabsState:Ls,TooltipLinkList:Is,TooltipMessage:Fs,TooltipNote:Hs,UL:Us,WithTooltip:zs,WithTooltipPure:Ds,Zoom:Vs,codeCommon:Ys,components:Ws,createCopyToClipboardFunction:Zs,getStoryHref:Gs,icons:Xs,interleaveSeparators:qs,nameSpaceClassNames:Ks,resetComponents:Js,withReset:Qs}=__STORYBOOK_COMPONENTS__});var na,ia,sa,aa,la,ca,ua,da,pa,ha,fa,ma,O,ga,va,ya,ba,f,xa,_a,wa,$a,Sa,Ea,Aa,L=w(()=>{d();p();h();na=__STORYBOOK_THEMING__,{CacheProvider:ia,ClassNames:sa,Global:aa,ThemeProvider:la,background:ca,color:ua,convert:da,create:pa,createCache:ha,createGlobal:fa,createReset:ma,css:O,darken:ga,ensure:va,ignoreSsrWarning:ya,isPropValid:ba,jsx:f,keyframes:xa,lighten:_a,styled:wa,themes:$a,typography:Sa,useTheme:Ea,withTheme:Aa}=__STORYBOOK_THEMING__});var Ne={};Vt(Ne,{Children:()=>Jo,Component:()=>et,Fragment:()=>E,Profiler:()=>Qo,PureComponent:()=>en,StrictMode:()=>tn,Suspense:()=>tt,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:()=>rn,cloneElement:()=>on,createContext:()=>nn,createElement:()=>sn,createFactory:()=>an,createRef:()=>ln,default:()=>Ko,forwardRef:()=>cn,isValidElement:()=>un,lazy:()=>rt,memo:()=>dn,useCallback:()=>F,useContext:()=>pn,useDebugValue:()=>hn,useEffect:()=>N,useImperativeHandle:()=>fn,useLayoutEffect:()=>mn,useMemo:()=>W,useReducer:()=>gn,useRef:()=>vn,useState:()=>T,version:()=>yn});var Ko,Jo,et,E,Qo,en,tn,tt,rn,on,nn,sn,an,ln,cn,un,rt,dn,F,pn,hn,N,fn,mn,W,gn,vn,T,yn,R=w(()=>{d();p();h();Ko=__REACT__,{Children:Jo,Component:et,Fragment:E,Profiler:Qo,PureComponent:en,StrictMode:tn,Suspense:tt,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:rn,cloneElement:on,createContext:nn,createElement:sn,createFactory:an,createRef:ln,forwardRef:cn,isValidElement:un,lazy:rt,memo:dn,useCallback:F,useContext:pn,useDebugValue:hn,useEffect:N,useImperativeHandle:fn,useLayoutEffect:mn,useMemo:W,useReducer:gn,useRef:vn,useState:T,version:yn}=__REACT__});var nt,ce,xn,_n,wn,Kt,Jt,Qt,Re=w(()=>{d();p();h();R();L();U();nt=function(o,e){return Object.defineProperty?Object.defineProperty(o,"raw",{value:e}):o.raw=e,o},ce=function(o){var e=o.config,t=o.defer,r=t===void 0?!1:t,n=T(r?void 0:e.url),i=n[0],s=n[1],c=T(!1),a=c[0],l=c[1];return N(function(){if(r){var u=requestAnimationFrame(function(){s(e.url)});return function(){return cancelAnimationFrame(u)}}},[r,e.url]),N(function(){l(!1)},[i]),f("div",{css:xn},!a&&f(I,{css:_n},"Loading..."),f("iframe",{css:wn,src:i,allowFullScreen:e.allowFullscreen,onLoad:function(){return l(!0)}}))},xn=O(Kt||(Kt=nt([`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`});var po,Tt,ho,fo,mo,kt=w(()=>{d();p();h();D();po=({onClick:o=()=>{}})=>j`
...
`)}},go=o=>[Math.trunc(255*o.r),Math.trunc(255*o.g),Math.trunc(255*o.b)],Wn=o=>{let[e,t,r]=go(o);return"#"+((1<<24)+(e<<16)+(t<<8)+r).toString(16).slice(1)},Nt=({property:o,value:e})=>`${o}: ${e};`});var Zn,Rt,yo,Gn,Xn,bo,xo=w(()=>{d();p();h();D();kt();vo();Zn=function(o,e,t,r){function n(i){return i instanceof t?i:new t(function(s){s(i)})}return new(t||(t=Promise))(function(i,s){function c(u){try{l(r.next(u))}catch(m){s(m)}}function a(u){try{l(r.throw(u))}catch(m){s(m)}}function l(u){u.done?i(u.value):n(u.value).then(c,a)}l((r=r.apply(o,e||[])).next())})},Rt=o=>Zn(void 0,void 0,void 0,function*(){yield navigator.clipboard.writeText(o)}),yo=({node:o,onClose:e})=>{if(!o)return null;let t=new We(o),r=n=>n.stopPropagation();return S`
  ...
  `},Gn=o=>{let e=()=>Rt(o.getStyleSheet()),t=o.getStyles();return S`<div class="inspector-section">
  ...
  </div>`},Xn=o=>{let{property:e,value:t,color:r}=o,n=null;switch(e){case"background":case"fill":case"border":case"box-shadow":case"color":n=S`<span
        class="color-preview"
...
`});var Bt,_o,wo,$o=w(()=>{d();p();h();D();De();Ee();Bt=({node:o,selected:e=!1,computedThickness:t,onClick:r})=>{let{x:n,y:i,width:s,height:c}=o.absoluteBoundingBox,a="cornerRadius"in o&&o.cornerRadius?{topLeft:o.cornerRadius,topRight:o.cornerRadius,bottomRight:o.cornerRadius,bottomLeft:o.cornerRadius}:"rectangleCornerRadii"in o&&o.rectangleCornerRadii?{topLeft:o.rectangleCornerRadii[0],topRight:o.rectangleCornerRadii[1],bottomRight:o.rectangleCornerRadii[2],bottomLeft:o.rectangleCornerRadii[3]}:{topLeft:0,topRight:0,bottomRight:0,bottomLeft:0},l=t/2,u=(b,$)=>`M${b},${$}`,m=(b,$)=>`L${b},${$}`,x=(b,$,A)=>`A${b},${b} 0 0 1 ${$},${A}`,_=[u(a.topLeft+l,l),m(s-a.topRight,l),x(a.topRight-l,s-l,a.topRight),m(s-l,c-a.bottomRight),x(a.bottomRight-l,s-a.bottomRight,c-l),m(a.bottomLeft,c-l),x(a.bottomLeft-l,l,c-a.bottomLeft),m(l,a.topLeft),x(a.topLeft-l,a.topLeft,l),"Z"].join(" ");return j`
    <path
      ...
      @click=${r}
    />
  `},_o=({nodeSize:{x:o,y:e,width:t,height:r},offsetX:n,offsetY:i,reverseScale:s})=>{let c={top:`${i+e+r}px`,left:`${n+o+t/2}px`,transform:`translateX(-50%) scale(${s}) translateY(0.25em)`};return S`
...
`});var Jn,So,Eo,Ao=w(()=>{d();p();h();Jn=[{gte:31536e6,divisor:31536e6,unit:"year"},{gte:2592e6,divisor:2592e6,unit:"month"},{gte:6048e5,divisor:6048e5,unit:"week"},{gte:864e5,divisor:864e5,unit:"day"},{gte:36e5,divisor:36e5,unit:"hour"},{gte:6e4,divisor:6e4,unit:"minute"},{gte:3e4,divisor:1e3,unit:"seconds"},{gte:0,divisor:1,text:"just now"}],So=o=>(typeof o=="object"?o:new Date(o)).getTime(),Eo=(o,e=Date.now(),t=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"}))=>{let n=So(e)-So(o),i=Math.abs(n);for(let s of Jn)if(i>=s.gte){let c=Math.round(Math.abs(n)/s.divisor),a=n<0,l=s.unit;return l?t.format(a?c:-c,l):s.text}}});var Po,Co,Mo=w(()=>{d();p();h();D();kt();Ao();Po=B`
  .figma-footer {
    flex: 0;
    z-index: calc(var(--z-index) + 1);
...
`,Co=o=>{if(!o||!o.link||o.link===void 0||o.link==="undefined")return null;let{link:e,timestamp:t,fileName:r}=o;return S`<a
    class="figma-footer"
    target="_blank"
    rel="noopener"
    title="Open in Figma"
...
`],[`
  ...
  bottom: 0;
  left: 0;
`]))),or,nr;d();p();h();R();L();U();var ar=function(o){var e=o.onZoomIn,t=o.onZoomOut,r=o.onReset;return f(E,null,f(Te,{onClick:e},f(ke,{icon:"zoom"})),f(Te,{onClick:t},f(ke,{icon:"zoomout"})),f(Te,{onClick:r},f(ke,{icon:"zoomreset"})))};d();p();h();R();var lr=function(o,e){var t=T(1),r=t[0],n=t[1];N(function(){n(o)},e);var i=F(function(){n(function(a){return a+.1})},[n]),s=F(function(){n(function(a){return Math.max(a-.1,.1)})},[n]),c=F(function(){n(1)},[n]);return{scale:r,zoomIn:i,zoomOut:s,resetZoom:c}};var lt=function(o,e){return Object.defineProperty?Object.defineProperty(o,"raw",{value:e}):o.raw=e,o},pr=function(o){var e=o.config,t=lr(e.scale||1,[e.scale]),r=W(function(){return{transform:"scale(".concat(t.scale,")")}},[t.scale]);return f("div",{css:An},f(Gt,{border:!0},f(E,{key:"left"},f("p",null,f("b",null,"Image")),f(Xt,null),f(ar,{onReset:t.resetZoom,onZoomIn:t.zoomIn,onZoomOut:t.zoomOut}))),f(sr,{css:Pn,defaultValue:e.offset},f("img",{css:Cn,src:e.url,style:r})))};var An=O(cr||(cr=lt([`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`],[`
  ...
  justify-content: center;
  align-items: center;
`]))),hr;d();p();h();U();L();R();Re();var ue=function(){return ue=Object.assign||function(o){for(var e,t=1,r=arguments.length;t<r;t++){e=arguments[t];for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(o[n]=e[n])}return o},ue.apply(this,arguments)},kn=function(o){if(o.protocol!=="https:")return{valid:!1,error:f(E,null,"Expected HTTPS link, received ",f("code",null,o.protocol),".")};if(o.hostname!=="www.sketch.com")return{valid:!1,error:f(E,null,"Expected a hostname ",f("code",null,"www.sketch.com"),", received"," ",f("code",null,o.hostname))};var e=f(E,null,"Expected pathname ",f("code",null,"/s/<string>/a/<string>"),", received"," ",f("code",null,o.pathname),"."),t=o.pathname.split("/").slice(1);if(t.length<4)return{valid:!1,error:e};if(t[0]==="embed")return{valid:!0,data:{url:o.href,offscreen:!1}};var r=t[0],n=t[1],i=t[2],s=t[3];return r!=="s"||!n||i!=="a"||!s?{valid:!1,error:e}:{valid:!0,data:{url:"https://www.sketch.com/embed/s/".concat(n,"/a/").concat(s),offscreen:!1}}},mr=function(o){var e=o.config,t=W(function(){var r=kn(new URL(e.url));return r.valid?ue(ue({},r),{data:ue(ue({},e),r.data)}):r},[e]);return t.valid?f(ce,{defer:!0,config:t.data}):f(I,null,f(E,null,"Invalid Sketch URL"),f(E,null,t.error))};d();p();h();R();L();U();var gr=function(o){var e=o.tabs,t=o.deps,r=t===void 0?[]:t,n=T(e[0].id),i=n[0],s=n[1];return N(function(){s(e[0].id)},r),f(qt,{absolute:!0,selected:i,actions:{onSelect:s}},e.map(function(c){return f("div",{key:c.id,id:c.id,title:c.name},c.offscreen||i===c.id?c.content:null)}))};var k=function(){return k=Object.assign||function(o){for(var e,t=1,r=arguments.length;t<r;t++){e=arguments[t];for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(o[n]=e[n])}return o},k.apply(this,arguments)},ui=function(o,e,t){if(t||arguments.length===2)for(var r=0,n=e.length,i;r<n;r++)(i||!(r in e))&&(i||(i=Array.prototype.slice.call(e,0,r)),i[r]=e[r]);return o.concat(i||Array.prototype.slice.call(e))},di=rt(function(){return Promise.resolve().then(()=>(Zo(),Wo))}),Go=function(o){var e=o.config;if(!e||"length"in e&&e.length===0)return f(I,null,f(E,null,"No designs found"),f(E,null,"Learn how to"," ",f(re,{href:"https://github.com/storybookjs/addon-designs#3-add-it-to-story",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"display design preview for the story")));var t=ui([],e instanceof Array?e:[e],!0).map(function(r){var n,i,s={id:JSON.stringify(r),name:r.name||((n=r.type)===null||n===void 0?void 0:n.toUpperCase())||"ERROR",offscreen:(i=r.offscreen)!==null&&i!==void 0?i:!0};switch(r.type){case"iframe":return k(k({},s),{content:f(ce,{config:r})});case"figma":return k(k({},s),{content:f(er,{config:r}),offscreen:!1});case"sketch":return k(k({},s),{content:f(mr,{config:r})});case"figspec":case"experimental-figspec":return r.type==="experimental-figspec"&&console.warn("[storybook-addon-designs] `experimental-figspec` is deprecated. We will remove it in v7.0. Please replace it to `figspec` type."),k(k({},s),{content:f(tt,{fallback:"Preparing Figspec viewer..."},f(di,{config:r})),offscreen:!1});case"image":return k(k({},s),{content:f(pr,{config:r})});case"link":return k(k({},s),{content:f(fr,{config:r})})}return k(k({},s),{content:f(I,null,f(E,null,"Invalid config type"),f(E,null,"Config type you set is not supported. Please choose one from"," ",f(re,{href:"https://github.com/pocka/storybook-addon-designs#available-types",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"available config types")))})});return t.length===1?f("div",null,t[0].content):f(gr,{tabs:t,deps:[e]})};var Ht=function(o){var e=o.active,t=Wt(),r=Me(le),n=T(e),i=n[0],s=n[1];return N(function(){s(e)},[r]),N(function(){e&&s(!0)},[e]),i?f(Go,{key:t.storyId,config:r}):null};var Pe="Design";function Ut(o){Ce.register(Oe,function(e){var t=function(){var r=Me(le);return r?Array.isArray(r)?r.length>0?"".concat(Pe," (").concat(r.length,")"):Pe:(r.name||Pe)+" (1)":Pe};o==="tab"?Ce.add(Qe,{title:Pe,render:function(r){var n=r.active,i=r.key;return n?f(ot,{key:i},f(Ht,{active:!0})):f("noscript",{key:i})},type:Yt.TAB,paramKey:le,route:function(r){var n=r.storyId;return"/design/".concat(n)},match:function(r){var n=r.viewMode;return n==="design"}}):Ce.addPanel(Qe,{title:t,paramKey:le,render:function(r){var n=r.active,i=r.key;return f(Zt,{key:i,active:!!n},f(ot,null,f(Ht,{active:!!n})))}})})}Ut("panel");})();
