...
import { Button, CheckboxField, Fieldset, Heading, LayoutFlow } from "@nl-rvo/component-library-react";
...
<ComponentExample>
  <Fieldset legend="Filters">
    <LayoutFlow gap="sm">
      <div className="rvo-layout-row rvo-layout-gap--sm">
        <input type="search" className="utrecht-textbox" aria-label="Zoeken" />
        <Button kind="primary">Zoek</Button>
      </div>
      <CheckboxField label="Ik ben/werk bij" invalid={false} options={[
        { id: "mkb", label: "MKB (ook zzp)", checked: true },
        { id: "grootbedrijf", label: "Grootbedrijf" },
        { id: "agro", label: "Land- en tuinbouw / Natuur / Visserij" },
      ]} />
      <CheckboxField label="Status" invalid={false} options={[
        { id: "open", label: "Open voor aanvragen", checked: true },
        { id: "bijna-open", label: "Bijna open voor aanvragen" },
        { id: "gesloten", label: "Gesloten voor aanvragen" },
      ]} />
    </LayoutFlow>
  </Fieldset>
</ComponentExample>
...
- Toon alleen filterwaarden die resultaten opleveren als er op door gefilterd wordt.
...
- <a
    href="https://web.archive.org/web/20210813184550/https://www.nngroup.com/articles/filter-categories-values/"
    className="rvo-link"
  >
    Defining Helpful Filter Categories and Values for Better UX - Kate Moran
  </a>
- <a href="https://uxdesign.cc/crafting-a-kickass-filtering-ux-beea1798d64b" className="rvo-link">
    How to craft a kickass filtering UX - Laura Cuhna
  </a>
- <a
    href="https://web.archive.org/web/20211016121449/https://baymard.com/blog/horizontal-filtering-sorting-design"
    className="rvo-link"
  >
    Filtering UI - Baymard Institute
  </a>
