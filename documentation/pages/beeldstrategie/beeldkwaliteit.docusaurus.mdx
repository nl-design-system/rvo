...
import { Card, Icon } from "@nl-rvo/component-library-react";
...
Foto's mogen niet groter zijn dan 2 MB.

**Headerfoto homepage, hoofdonderwerp- of doelgroeppagina**

- Afmeting: 1920 × 750 pixels.
...
Illustraties en animaties worden vormgegeven in de rijksbrede illustratiestijl volgens de bijbehorende animatierichtlijnen. Kijk voor het grid en de specifieke richtlijnen op <a href="https://www.rijkshuisstijl.nl" className="rvo-link">rijkshuisstijl.nl</a>.
