...
Deze vragen zijn beantwoord door mij, Robert Roose, Design Lead bij de Rijksdienst voor Ondernemend Nederland (RVO). Staat jouw vraag er niet bij? Stuur dan een mail naar <a href="mailto:robert.roose@rvo.nl" className="rvo-link">robert.roose@rvo.nl</a> of <a href="mailto:designsystem@rvo.nl" className="rvo-link">designsystem@rvo.nl</a>.
...
1. Voor iedereen als documentatie op <a href="https://rvo.nl/roos" className="rvo-link">rvo.nl/roos</a>.
2. Voor ontwikkelaars (developers) in <a href="https://nl-design-system.github.io/rvo/" className="rvo-link">Storybook</a> en <a href="https://github.com/nl-design-system/rvo" className="rvo-link">Github</a>.
3. Voor ontwerpers (designers) in <a href="https://www.figma.com/file/Sj6myBL1Fvot5M1qGxzvEo/ROOS-(RVO-Design-System)?type=design&node-id=484-13305&t=vZTjQBvAiufxd5Qs-0" className="rvo-link">Figma</a>.
