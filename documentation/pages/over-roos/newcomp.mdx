...
1. Ga na of het component al bestaat in ROOS door contact op te nemen met het Design System team in Teams, het <a href="https://matter.dtnr.nl/signup_user_complete/?id=jpmrorwwefnqfn5oufsw4i6t8e&md=link&sbr=su" className="rvo-link">#ROOS kanaal in Mattermost</a> (voor RVO en DICTU medewerkers) of stuur een mail naar <a href="mailto:designsystem@rvo.nl" className="rvo-link">designsystem@rvo.nl</a>.
...
7. Hierna wordt het component gebouwd in <a href="https://github.com/nl-design-system/rvo" className="rvo-link">code</a> en beschikbaar gesteld in <a href="https://nl-design-system.github.io/rvo/" className="rvo-link">Storybook</a>.
8. Er wordt documentatie geschreven voor het component dat wordt opgenomen in de <a href="https://www.rvo.nl/roos" className="rvo-link">documentatieomgeving</a>.
...
Heb je vragen of opmerkingen over dit proces? Stuur dan een e-mail naar <a href="mailto:designsystem@rvo.nl" className="rvo-link">designsystem@rvo.nl</a>.
