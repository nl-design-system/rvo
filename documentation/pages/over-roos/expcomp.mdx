...
- ROOS biedt ook de mogelijkheid om het experimentele component te ontwikkelen in de <a href="https://github.com/nl-design-system/rvo" className="rvo-link">GitHub codebase</a>. Toegang tot de codebase kan aangevraagd worden door een mail te sturen naar <a href="mailto:designsystem@rvo.nl" className="rvo-link">designsystem@rvo.nl</a> of door contact op te nemen met het ROOS kernteam in <a href="https://matter.dtnr.nl/signup_user_complete/?id=jpmrorwwefnqfn5oufsw4i6t8e&md=link&sbr=su" className="rvo-link">MatterMost</a>.
- Experimentele componenten hebben een eigen plek binnen <a href="https://nl-design-system.github.io/rvo/" className="rvo-link">Storybook</a>. Hierdoor is inzichtelijk welke componenten er momenteel in ontwikkeling zijn bij de verschillende teams binnen RVO.
...
- Heeft het experimentele component zichzelf bewezen en denk je dat het een goede toevoeging is voor de generieke set componenten van ROOS? Neem dan contact op met het ROOS kernteam <a href="https://matter.dtnr.nl/signup_user_complete/?id=jpmrorwwefnqfn5oufsw4i6t8e&md=link&sbr=su" className="rvo-link">MatterMost</a>.
