...
- When using laws, names and subsidies, use the Dutch term in brackets and italics after the term in English. For example: 'Environmental Management Activities Decree (_Activiteitenbesluit Milieubeheer_)'.
- Acronyms are generally not italicised, as they are often used throughout texts. When first introduced, write it as follows: 'During registration, we will ask for your Citizen Service Number (_Burgerservicenummer, BSN_').
...
| --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| De gebruiker heeft geen antwoord gegeven op een verplichte vraag.                                               | You have not filled in your [...]. This is a mandatory field. Please fill in your [...].                                 |
| De gebruiker heeft geen keuze gemaakt bij een verplichte vraag.                                                 | You have not filled in your [...]. This is a mandatory field. You must make a choice.                                    |
| De gebruiker heeft een ongeldige postcode ingevuld en wil zoeken op postcode.                                   | Fill in a vaild postcode (for example: 1234 AA). (_niet gebruiken voor buitenlandse postcodes_)                          |
| Plaatsnaam niet bekend en gebruiker wil zoeken op plaatsnaam.                                                   | No place names starting with those letters have been found.                                                              |
| De gebruiker heeft geen postcode ingevuld en wil zoeken op postcode.                                            | Fill in a valid postcode (for example: 1234 AA).                                                                         |
| De gebruiker heeft geen plaatsnaam ingevuld en wil zoeken op plaatsnaam.                                        | Fill in your place to continue.                                                                                          |
| Datum is leeg (niet gevuld).                                                                                    | You have not filled in a date. This is a mandatory field. Please fill in a date (dd-mm-jjjj)                             |
| Datum bestaat niet.                                                                                             | Fill in a valid date (dd-mm-jjjj).                                                                                       |
| Het telefoonnummer voldoet niet aan de voorwaarden. Het ingevulde telefoonnummer is ongeldig.                   | Fill in a correct phone number (for example: 0612345678)                                                                 |
| Het e-mailadres voldoet niet aan de voorwaarden. Het ingevulde e-mailadres bij vraag 'E-mailadres' is ongeldig. | Fill in a correct email address (for example: `name@example.com`).                                                       |
...
| Een veld moet een bepaalde waarde hebben.                                                                       | Enter an amount with 2 decimal numbers                                                                                   |
|                                                                                                                 | The percentage should be between 0 and 50.                                                                               |
|                                                                                                                 | The amount cannot be lower than 100.                                                                                     |
...
Go to the <a href="https://nl-design-system.github.io/rvo/docs/schrijfwijzer/Servicepagina's/" class="rvo-link">Service pages</a> page for instructions and for the Dutch and English texts for these pages.
