...
- <a href="https://www.oxfordlearnersdictionaries.com/" className="rvo-link">Oxford Learner’s Dictionaries <span aria-hidden="true" className="utrecht-icon rvo-icon rvo-icon-externe-link rvo-icon--md rvo-icon--hemelblauw"></span></a>
- <a href="https://www.collinsdictionary.com/dictionary/english#google_vignette" className="rvo-link">Collins Advanced Learners Dictionary <span aria-hidden="true" className="utrecht-icon rvo-icon rvo-icon-externe-link rvo-icon--md rvo-icon--hemelblauw"></span></a>
- <a href="https://dictionary.cambridge.org/" className="rvo-link">Cambridge Online Dictionary <span aria-hidden="true" className="utrecht-icon rvo-icon rvo-icon-externe-link rvo-icon--md rvo-icon--hemelblauw"></span></a>

### Translate and synonyms

- <a href="https://iate.europa.eu/home" className="rvo-link">IATE <span aria-hidden="true" className="utrecht-icon rvo-icon rvo-icon-externe-link rvo-icon--md rvo-icon--hemelblauw"></span></a>
- <a href="https://www.linguee.nl/" className="rvo-link">Linguee <span aria-hidden="true" className="utrecht-icon rvo-icon rvo-icon-externe-link rvo-icon--md rvo-icon--hemelblauw"></span></a>
- <a href="https://context.reverso.net/vertaling/" className="rvo-link">Reverso Context <span aria-hidden="true" className="utrecht-icon rvo-icon rvo-icon-externe-link rvo-icon--md rvo-icon--hemelblauw"></span></a>
- <a href="https://www.collinsdictionary.com/dictionary/english-thesaurus" className="rvo-link">Collins Advanced Learners Thesaurus <span aria-hidden="true" className="utrecht-icon rvo-icon rvo-icon-externe-link rvo-icon--md rvo-icon--hemelblauw"></span></a>
...
- <a href="https://hemingwayapp.com/" className="rvo-link">Hemingway App <span aria-hidden="true" className="utrecht-icon rvo-icon rvo-icon-externe-link rvo-icon--md rvo-icon--hemelblauw"></span></a>
- <a href="https://www.webfx.com/tools/read-able/" className="rvo-link">Web FX readability test tool <span aria-hidden="true" className="utrecht-icon rvo-icon rvo-icon-externe-link rvo-icon--md rvo-icon--hemelblauw"></span></a>
