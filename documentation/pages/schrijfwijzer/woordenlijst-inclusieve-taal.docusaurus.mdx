...
sidebar_anchors:
  - anchor: zwart-en-wit
    label: Zwart en wit
  - anchor: genderinclusief-taalgebruik
    label: Genderinclusief taalgebruik
  - anchor: gendergelijkheid-bij-internationale-rvo-projecten
    label: Gendergelijkheid bij internationale RVO-projecten
  - anchor: mensen-met-een-beperking
    label: Mensen met een beperking
  - anchor: beroepen
    label: Beroepen
  - anchor: opleiding
    label: Opleiding
  - anchor: oorspronkelijke-bevolking
    label: Oorspronkelijke bevolking
  - anchor: delen-van-de-wereld-en-bevolking
    label: Delen van de wereld en bevolking
  - anchor: nationaliteit-en-dubbele-nationaliteit
    label: Nationaliteit en dubbele nationaliteit
  - anchor: specifieke-namen
    label: Specifieke namen
  - anchor: erkenning
    label: Erkenning
---
...
Rijksbrede afspraken over inclusief schrijven staan in het <Link href="https://www.communicatierijk.nl/vakkennis/taalkompas/inclusief-schrijven" showIcon="after" icon="externe-link">Taalkompas</Link>. Op deze pagina vind je aanvullende handvatten voor inclusieve taal. Deze woordenlijst bevat aanbevelingen op verschillende diversiteitsgebieden, maar is niet volledig. Gebruik deze woordenlijst daarom ter inspiratie.
...
In het kader van de Algemene verordening Gegevensbescherming (AVG) en de Wet modernisering elektronisch bestuurlijk verkeer (WMEBV) mogen we ‘onnodige’ gegevens zoals gender niet uitvragen. Moet je gender uitvragen vanwege beleidsdoelstellingen, dan leg je in het formulier uit waarom je dat doet.

Gebruik de volgende keuzeopties bij het vragen naar gender:
