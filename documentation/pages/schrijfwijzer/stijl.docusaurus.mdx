...
Huisstijlsjablonen zijn beschikbaar in de applicatie SmartDocuments. Heb je een sjabloon nodig voor een bijlage? Vraag het sjabloon dan op bij de managementondersteuner van jouw manager. Maak je veel gebruik van sjablonen? Dan kun je via jouw manager een licentie vragen voor SmartDocuments.
