...
sidebar_anchors:
  ...
  - anchor: woordgebruik
    label: Woordgebruik
  - anchor: zinsconstructies
    label: Zinsconstructies
  - anchor: aanhalingstekens
    label: Aanhalingstekens
  - anchor: afkortingen
    label: Afkortingen
  - anchor: cijfers
    label: Cijfers
  - anchor: datums-en-tijd
    label: Datums en tijd
  - anchor: hoofdletters-functienamen-en-aardrijkskundige-namen
    label: Hoofdletters, functienamen en aardrijkskundige namen
  - anchor: telefoonnummers
    label: Telefoonnummers
  - anchor: samengestelde-woorden
    label: Samengestelde woorden
---
...
Controleer webteksten in Drupal met de ingebouwde plugin Klinkende Taal. Gebruik voor andere teksten de <a href="https://intra.rvo.nl/Project/DigitalecontentKlantkanalenenmiddelen/Pages/NP6tRfukWkmvADgRz84_fA" class="rvo-link">webtool</a>.

## Woordgebruik

- Gebruik eenvoudige woorden.

- Vermijd ouderwetse termen en ambtelijke taal, zie <a href="/rvo/docs/schrijfwijzer/woordenlijst-begrijpelijke-taal/#ouderwetse-woorden" className="rvo-link">Woordenlijst ouderwetse woorden</a>.<br/>Schrijf 'en', in plaats van 'alsmede'.
...
- Gebruik geen onnodig lange voorzetsels. In <a href="/rvo/docs/schrijfwijzer/naslagwerken-en-links" className="rvo-link">Naslagwerken en Links</a> staan links naar websites die alternatieven geven voor onnodig ingewikkelde of ambtelijke woorden. Schrijf 'door' in plaats van 'ten gevolge van' of 'door middel van'.
...
Huisstijlsjablonen zijn beschikbaar in de applicatie SmartDocuments. Heb je een sjabloon nodig voor een bijlage? Vraag het sjabloon dan op via de managementondersteuner van jouw team. Maak je veel gebruik van sjablonen? Dan kun je via <a href="mailto:huisstijl@rvo.nl" className="rvo-link">{"huisstijl@rvo.nl"}</a> een licentie vragen voor SmartDocuments.
...
Gebruik voor letterlijke citaten altijd rechte, dubbele aanhalingstekens.
...
Als je een hele zin citeert, begint het citaat met een hoofdletter. Als het citaat aan het eind van de zin staat, valt de punt binnen de aanhalingstekens. Ook een vraagteken of uitroepteken dat bij het citaat hoort, valt binnen de aanhalingstekens:

> - De algemeen directeur zei: "Het is een subsidie voor de investeringskosten en dat was precies wat we zochten."
> - De algemeen directeur vroeg: "Is het een subsidie voor de investeringskosten?"
> - De algemeen directeur riep: "Dat is goed nieuws!"

Als de zin begint met het citaat, vervalt de punt, en wordt het citaat gevolgd door een komma. Een vraagteken of uitroepteken blijft staan. Na een vraagteken of uitroepteken, schrijven we ook een komma. Zo ziet de lezer meteen dat de zin nog niet is afgelopen.

> - "Het is een subsidie voor de investeringskosten en dat was precies wat we zochten", zegt de algemeen directeur.
> - "Is het een subsidie voor de investeringskosten?", vroeg de algemeen directeur.
> - "Dat is goed nieuws!", riep de algemeen directeur.

Op de website van Onze Taal vind je meer uitleg over het <a href="https://onzetaal.nl/taalloket/aanhalingstekens-en-leestekens" className="rvo-link">gebruik van aanhalingstekens en andere leestekens</a>.
...
- Gebruik dhr. en mevr.
- Voor internationaal erkende symbolen in handel, techniek en wetenschap gelden de internationaal vastgelegde conventies: kg, mm, kW, kWh, MW, MWh, GW, GWh, CO<sub>2</sub>, Hz, H<sub>2</sub>O, brt, °C en km<sup>2</sup>.
...
- Negatieve getallen schrijf je met een minteken (-) ervoor, zoals -5 of -100.
- Vul rangtelwoorden aan met een 'e' in het superscript: 1ᵉ, 23ᵉ, 75ᵉ.
...
- Schrijf € -10 voor een negatief bedrag (een schuld) en - € 10 voor een korting (een aftrek).
...
- Machten mogen worden afgekort: vierkante meter = m², kubieke meter = m³.
  N.B. Gebruik super- en subscript om de correcte notatie te krijgen. Gebruik alt-codes om super- of subscript in de titel te krijgen: <a href="https://altcodeunicode.com/alt-codes-math-symbols-superscript-subscript-numbers" className="rvo-link">{"https://altcodeunicode.com/alt-codes-math-symbols-superscript-subscript-numbers"} <span aria-hidden="true" className="utrecht-icon rvo-icon rvo-icon-externe-link rvo-icon--md rvo-icon--hemelblauw"></span></a>.
...
- Als in de tekst al woorden staan als 'afname', 'daling', 'vermindering' of 'korting', is een minteken voor een percentage overbodig en dubbelop. In tabellen en grafieken gebruik je vanwege de compactheid wel vaak een minteken.

> - In het Midden-Oosten is er een afname van de exportwaarde van 1,3%.
> - De exportwaarde naar Afrika is met 9,45% gedaald.
...
In lopende tekst en bovenaan brieven schrijven we datums als volgt: 9 januari 2025 én 1 juni 2023 tot en met 31 augustus 2023. Afkortingen als 'jl.' en 'a.s.' gebruiken we niet.

In tabellen en infographics gebruik je een verkorte notatie met cijfers en streepjes: 09-01-2025 (dd-mm-jjjj met daarbij een leidende 0 bij de dag- en maandaanduiding).

We hebben ons geconformeerd aan de tijdschrijfwijze van Ondernemersplein. We schrijven 09:00 uur en niet 09.00 uur, en ook niet 09:00 u.
...
Engelse woorden in een Nederlandse tekst cursiveren we niet, behalve als de kans groot is dat de lezer het woord niet kent. In dat geval is het verstandig om het Engelse woord de eerste keer te cursiveren of tussen enkele aanhalingstekens te zetten. Je kunt dat woord ook van een korte toelichting voorzien.

## Hoofdletters, functienamen en aardrijkskundige namen

De woorden ministerie, ambassade, minister, president, staatssecretaris en dergelijke schrijf je met een kleine letter: het ministerie van Economische Zaken. Het Rijk, de Kamer en de Staat krijgen wel een hoofdletter.

Let op: het is 'rijksambtenaar' met een kleine letter maar 'Kamervragen' met een hoofdletter.

### Afdelingsnamen

Bij RVO is alleen de eerste letter van een afdelingsnaam met een hoofdletter. We gebruiken zoveel mogelijk de volledig uitgeschreven naam van een afdeling. In afdelingsnamen staan geen speciale tekens. We gebruiken 'en' in plaats van '&'.

> - Piet werkt bij de afdeling Mens en organisatie.
> - De afdeling Mens en organisatie is onderdeel van RVO.

### Functienamen

Functienamen schrijven we met kleine letters. Ook als er een naam volgt na de functienaam, of als de afkorting RVO gecombineerd wordt met een functienaam.

Soms maakt de naam van een afdeling deel uit van de functienaam. Omdat we in onze organisatie de eerste letter van een afdelingsnaam met een hoofdletter schrijven, houden ze ook in de functienaam hun hoofdletter.

> - directeur-generaal
> - eindredacteur
> - senior strategisch bestuursadviseur
> - RVO-adviseur
> - afdelingsmanager Mens en organisatie

Let op: Aan het begin van een zin, regel of titel krijgt een functienaam wel een hoofdletter.

### Aardrijkskundige namen

Aardrijkskundige namen en samengestelde aardrijkskundige namen beginnen met een hoofdletter: Verenigd Koninkrijk, Latijns-Amerika. Voor de spelling van geografische namen volgen we de spelling van de Taalunie.

Bij namen van landen die bestaan uit meerdere staten, eilanden of emiraten gebruiken we enkelvoud. Denk aan: Verenigde Staten (VS), Verenigde Arabische Emiraten (VAE), Filipijnen, Malediven, etc. Op onze website ligt het accent op het land als geheel (als één entiteit).

N.B. Landennamen en de landentaxonomie horen overeen te komen op onze websites.

## Telefoonnummers

We verdelen telefoonnummers in groepjes met een spatie ertussen. Bij een driecijferig netnummer verdeel je het abonneenummer in groepen van 3, 2 en 2 cijfers. Het netnummer plaatsen we niet tussen haakjes:
...
Het 088-nummer van RVO schrijven we als volgt:

> _088 042 42 42_

Bij mobiele nummers verdelen we de cijfers in groepen van 2:

> _06 23 44 55 67_

Internationale nummers (zoals het nummer waarop we bereikbaar zijn vanuit het buitenland) schrijf je als volgt:

> _+31 70 379 80 00_ > _+31 6 23 44 55 67_
...
Daarnaast vind je er antwoorden op veelgestelde vragen over betalen aan RVO. Bijvoorbeeld: hoe vraagt een relatie een betalingsregeling aan? Of wat te doen als iemand een factuur heeft betaald maar toch een aanmaning ontvangt?
...
> Heeft u vragen over betalen aan RVO? Meer informatie hierover vindt u op <a class="rvo-link" href="https://www.rvo.nl/rekeningnummers">Rekeningnummers van RVO</a>.
...
> - de Rijksdienst voor Ondernemend Nederland en zijn medewerkers
