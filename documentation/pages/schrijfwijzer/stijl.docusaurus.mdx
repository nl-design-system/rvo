...
Soms maakt de naam van een afdeling deel uit van de functienaam. Omdat het in onze organisatie gebruikelijk is om zulke namen met een hoofdletter te schrijven, houden ze ook in de functienaam hun hoofdletter.

> - directeur-generaal
> - eindredacteur
> - senior strategisch bestuursadviseur
> - RVO-adviseur
> - afdelingsmanager Personeel & Organisatie

Let op: Aan het begin van een zin, als titel van een webpagina of paragraaf of aan het begin van een regel (bij ondertekening van een brief of in een quote op de website) krijgt een functienaam wel een hoofdletter.

> Aan het begin van een zin:
> 'Directeur-generaal De Vries bracht een bezoek aan...'

> Titel webpagina of paragraaf:
> Afdelingsmanager Personeel & Organisatie

> Ondertekening brief of quote op website:
> Piet Jansen
> Processpecialist

_Aardrijkskundige namen_
