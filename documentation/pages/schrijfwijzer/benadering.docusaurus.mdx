...
sidebar_position: 3
sidebar_anchors:
  - anchor: aanspreekvormen
    label: Aanspreekvormen
  - anchor: schrijf-in-de-ikwij-vorm
    label: Schrijf in de ik/wij-vorm
  - anchor: wees-concreet-en-persoonlijk
    label: Wees concreet en persoonlijk
  - anchor: toon-begrip-niet-meehuilen-wel-meeleven
    label: Toon begrip; niet meehuilen, wel meeleven
  - anchor: vraag-begrip
    label: Vraag begrip
  - anchor: denk-positief-schrijf-positief
    label: Denk positief, schrijf positief
  - anchor: blijf-professioneel-onder-alle-omstandigheden
    label: Blijf professioneel... onder alle omstandigheden
  - anchor: naamgebruik-rijksdienst-voor-ondernemend-nederland
    label: Naamgebruik Rijksdienst voor Ondernemend Nederland
  - anchor: websites-en-intranet
    label: Websites en intranet
  - anchor: adres-en-persoonsgegevens
    label: Adres- en persoonsgegevens
  - anchor: verwijzen-naar-kvk-en-ondernemersplein
    label: Verwijzen naar KVK en Ondernemersplein
---
...
- In gedrukte communicatiemiddelen (zoals flyers en folders) mag je 'jij/je' gebruiken als dit aansluit bij de doelgroep en context, bijvoorbeeld in een bijsluiter bij het VISblad. Dit type communicatie beschouwen we als informeel, vergelijkbaar met onze socialmediakanalen.
...
Neem bij twijfel contact op met een van de <a className="rvo-link" href="/rvo/docs/schrijfwijzer/waarom-deze-schrijfwijzer/#vragen">kanaal- en middelspecialisten</a> van team Klantkanalen en middelen.
...
De naam 'Rijksdienst voor Ondernemend Nederland (RVO)' telt 44 tekens.<br/>
...
### Gebruik lidwoord 'de' voor naam/afkorting\_
...
> - FastLane is een pilot waarin **de Rijksdienst voor Ondernemend Nederland (RVO)** veelbelovende start-ups en scale-ups helpt hun groei te versnellen.
...
Wat betreft naamgeving van nieuwsbrieven hanteren we:

- RVO-nieuwsbrief (als je naar de nieuwsbrief verwijst)
- nieuwsbrief Overheden (kleine letter n (tenzij aan begin van een zin) en hoofdletter O, omdat we 'Overheden' als naam van de nieuwsbrief zien) 
...
### Omgaan met oude organisatienamen
...
##### Uitzondering: NL Octrooicentrum

Voor verwijzingen naar NL Octrooicentrum gelden de volgende afspraken:<br/>
