...
<h3 id="foutmeldingen">Foutmeldingen</h3>
...
| _Wat gebeurt er?_                                                                                               | _Meldingstekst_                                                                                                   |
| --------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| De gebruiker heeft geen antwoord gegeven op een verplichte vraag.                                               | Het veld [veldnaam] is niet ingevuld, maar wel verplicht. Vul uw [veldnaam] in.                                   |
| De gebruiker heeft geen keuze gemaakt bij een verplichte vraag.                                                 | Het veld [veldnaam] is niet ingevuld, maar wel verplicht. Maak een keuze.                                         |
| De gebruiker heeft een ongeldige postcode ingevuld en wil zoeken op postcode.                                   | Vul een geldige postcode in (bijvoorbeeld: 1234 AB).                                                              |
...
| De gebruiker heeft geen postcode ingevuld en wil zoeken op postcode.                                            | Vul een geldige postcode in (bijvoorbeeld: 1234 AB).                                                              |
| De gebruiker heeft geen plaatsnaam ingevuld en wil zoeken op plaatsnaam.                                        | Vul een plaatsnaam in om door te gaan met zoeken.                                                                 |
| Datum is leeg (niet gevuld).                                                                                    | Het veld Datum is niet ingevuld, maar wel verplicht. Vul een datum in (dd-mm-jjjj).                               |
| Datum bestaat niet.                                                                                             | Vul een geldige datum in (dd-mm-jjjj).                                                                            |
...
| Het e-mailadres voldoet niet aan de voorwaarden. Het ingevulde e-mailadres bij vraag 'E-mailadres' is ongeldig. | Vul een geldig e-mailadres in (bijvoorbeeld: naam@voorbeeld.nl).                                                  |
| De ingevulde adressen bij vraag 'E- mailadres' en 'Nogmaals e-mailadres' zijn ongelijk aan elkaar.              | De e-mailadressen die u heeft ingevuld zijn niet hetzelfde. Vul 2 keer hetzelfde e-mailadres in.                  |
...
| Geboortejaar ligt in de toekomst.                                                                               | Het geboortejaar ligt in de toekomst. Vul uw geboortedatum juist in.                                              |
...
| Een veld moet en bepaalde waarde hebben.                                                                        | Vul een bedrag in met 2 cijfers achter de komma.                                                                  |
|                                                                                                                 | Het percentage moet tussen 0 en 50 liggen.                                                                        |
|                                                                                                                 | Het bedrag mag niet lager zijn dan 1.000.                                                                         |
