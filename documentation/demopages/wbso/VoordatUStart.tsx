        ...
        <main className="rvo-progress-tracker-active">
          <ProgressTracker
            steps={[
              ...
              { state: 'doing', label: 'Voordat u start', link: '#', size: 'md', line: 'straight' },
              { state: 'incomplete', label: 'Vormvrije aanvraag', link: '#', size: 'md', line: 'straight' },
              { state: 'incomplete', label: 'Aanvrager', link: '#', size: 'md', line: 'straight' },
