...
const Formulier = () => {
  return (
    <div className="rvo-demo-page rvo-rhs-nieuw">
      <header className="rvo-header">
        <div className="rvo-header__logo-wrapper">
          <a href="/" className="rvo-header__logo-link--new">
            <img src="images/lint.svg" className="rvo-lint" />
            <span className="rvo-logo-tekst">Rijksdienst voor Ondernemend Nederland</span>
          </a>
        </div>
      </header>
